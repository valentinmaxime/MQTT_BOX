/**
 * @Author: Val
 * @Date:   2018-05-08T18:10:19+02:00
 * @Project: MQTT_CLIENT
 * @Last modified by:   Val
 * @Last modified time: 2018-05-09T13:30:02+02:00
 */
...
void GravityTDS::update()
{
  ...
  this->ecValue=(133.42*this->voltage*this->voltage*this->voltage - 255.86*this->voltage*this->voltage + 857.39*this->voltage)*1;
